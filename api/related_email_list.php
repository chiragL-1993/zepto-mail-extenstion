...
$cssArray = [
    ...
    WIDGET_URI  . "/ui/css/related_email_list.css?v='" . time() . "'",
];
$jsArray = [
    WIDGET_URI  . "/ui/js/common.js?v='" . time() . "'",
    WIDGET_URI  . "/ui/js/related_email_list.js?v='" . time() . "'",
];

$widget->render(
    "Email History Related List",
    $cssArray,
    $jsArray,
    file_get_contents(__DIR__ . "/../ui/html/related_email_list.php")
);
