...
$cssArray = [
    ...
    "https://cdn.jsdelivr.net/gh/abpetkov/switchery/dist/switchery.min.css",
];
$jsArray = [
    "https://cdn.jsdelivr.net/npm/flatpickr",
    "https://cdn.jsdelivr.net/gh/abpetkov/switchery/dist/switchery.min.js",
    "https://cdn.ckeditor.com/ckeditor5/41.1.0/classic/ckeditor.js",
    WIDGET_URI  . "/ui/js/common.js?v='" . time() . "'",
    WIDGET_URI  . "/ui/js/email_widget.js?v='" . time() . "'",
];
...
$widget->render(
    ...
    $cssArray,
    $jsArray,
    file_get_contents(__DIR__ . "/../ui/html/email_widget.php")
);
